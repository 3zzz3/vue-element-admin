<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="领料单号" prop="id" align="center" width="100">
        <template slot-scope="{row}">
          <span>{{ row.lingLiaoDanHao }}</span>
        </template>
      </el-table-column>
      <el-table-column label="物料名称" prop="id" align="center" width="100">
        <template slot-scope="{row}">
          <span>{{ row.wuLiaoMingChen }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="需求数量" prop="id" align="center" width="100">
        <template slot-scope="{row}">
          <span>{{ row.xuQiuShuLiang }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="标准值上限" prop="id" align="center" width="100">
        <template slot-scope="{row}">
          <span>{{ row.biaoZhunZhiShangXian }}</span>
        </template>
      </el-table-column>
      <el-table-column label="标准值下限" prop="id" align="center" width="100">
        <template slot-scope="{row}">
          <span>{{ row.biaoZhunZhiXiaXian }}</span>
        </template>
      </el-table-column>
